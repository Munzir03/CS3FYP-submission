...
<style>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse mt-md-3" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item">
                            <button class="nav-link pl-0 pr-0 active" aria-label="Go to home"><a href="index.php">Home</a></button>
                        </li>
                        <li class="nav-item">
    ...
    <div class="container main-container">
        <div id="cv">
            ...
            <div id="add-section">
                ...
                <button id="add-section-btn" class="text-center" aria-label="Add new section" onclick="redirectToBuilder()">
    ...
    <script>
        ...
        function redirectToBuilder() {
            ...
            if (isLoggedIn) {
                // If user is logged in, redirect to builder.html
