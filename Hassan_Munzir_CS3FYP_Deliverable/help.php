            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse mt-md-3" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <button class="nav-link pl-0 pr-0" aria-label="Switch to My Resumes page"><a href="builder.php">Create a Resume
            ...
            <div class="col-md-8">
                <div class="card mt-5">
                    ...
                    <div class="card-body">
                        ...
                        <p>Create an account or log in to get started with the CV builder. Your account allows you to save your work and come back to it later.</p>

                        <img src="step1.png" alt="Step 1: Register or Login" class="img-fluid">
                        <br>
                        <br>
                        <br>
                        <br>
                        ...
                        <p>Enter your personal details, educational background, work experience, skills, and any other relevant information.</p>
                        ...
                        <p>Choose one of the templates to suits youre requirements.</p>
                        <br>
                        <br>
                        <br>
                        <br>
                        ...
                        <br>
                        <h3>Step 4: Preview Your CV</h3>
                        <p>Preview your CV to make sure everything looks good. You can go back and edit any section as needed.</p>
                        ...
                        <br>
                        <br>
                        <h3>Step 5: Download Your CV</h3>
                        <p>When you're satisfied with your CV, download it as a PDF (you will find the button on the bottom of the page)and you're ready to apply for your next job!</p>
